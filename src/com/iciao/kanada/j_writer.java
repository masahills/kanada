...
import com.iciao.kanada.maps.map_ascii;
import com.iciao.kanada.maps.map_half_katakana;
import com.iciao.kanada.maps.map_hiragana;
import com.iciao.kanada.maps.map_katakana;
import com.iciao.kanada.maps.map_wide_ascii;
import com.iciao.kanada.maps.map_wide_symbol;

/**
 * Main string bufffer class.<br>
 *
...
public class j_writer
{
	...
	public String map()
	{
		...
		if ( kanada_mbr.mode_uc_all_mbr )
		{
			return out_str.toString().toUpperCase(Locale.ENGLISH);
		}
		else
		{
