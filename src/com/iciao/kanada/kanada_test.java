...
public class kanada_test
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			romanizer	= new kanada(kanada_def.CONFIG_GET_KATAKANA);
		}
		catch ( IOException e )
		{
	...
	private static final String TEST_TEXT =
		"第二次安倍改造内閣は3日夕方、皇居での認証式を経て正式に発足した。安倍晋三首相はこの後、首相官邸で記者会見し、改造内閣を「実行実現内閣」と命名するとともに、「引き続き経済最優先でデフレからの脱却を目指し、成長戦略の実行に全力を尽くす」と表明。地方創生、安全保障法制の整備についても重点的に取り組む方針を打ち出した。(時事通信)";
